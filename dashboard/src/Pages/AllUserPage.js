...
const AllUserPage = () => {
  ...
  const [sucessModuleview, setsucessModuleview] = useState(false);
  ...
  const deletedata = async () => {
    try {
      ...
      const userdata = await response.json();
      setsuccessmassage(userdata.message);
      console.log("Success response =>", userdata.message);
    } catch (error) {
      console.log("error=>", error.message);
    ...
    <div className="  w-full relative  flex  justify-center flex-col ">
      ...
      <div className="w-full h-full flex justify-center items-center ">
        ...
        <div
          ...
          tabindex="-1"
          aria-hidden="true"
          className={`  w-4/12 mt-14  ${sucessModuleview ? "" : "hidden"} `}
        >
